        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              inputfield_widget(name,false,CustomColors.backgroundColor),

              const SizedBox(height: 20),
              inputfield_widget(mail,false,CustomColors.backgroundColor),

              const SizedBox(height: 20),
              inputfield_widget(phoneno,false,CustomColors.backgroundColor),

              const SizedBox(height: 20),
              inputfield_widget(pass,true,CustomColors.backgroundColor),

              //input field via password
              const SizedBox(height: 20),
              inputfield_widget(Sapid,false,CustomColors.backgroundColor),
