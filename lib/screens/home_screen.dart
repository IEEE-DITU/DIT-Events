        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 250, child: EventList()),
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 10),
                child: Text(
                  'CLUBS & SOCIETIES',
              ...
              const ClubList(categoryName: 'MUSIC', imageList: [
              ...
              const ClubList(categoryName: 'ARTS', imageList: [
                'Assets/photos5.jpg',
                'Assets/photo1.png',
                'Assets/photos6.png',
                'Assets/photos7.jpg'
